...
const ru = {
  ...
  "app.title": "Состояние auth-токенов",
  "app.subtitle":
    "Панель состояния: видно здоровье refresh-цикла, состояние отслеживаемых auth-файлов и ближайшие обновления.",
...
const en: typeof ru = {
  ...
  "app.title": "Auth Token Status",
  "app.subtitle":
    "Dashboard for refresh-cycle health, tracked auth-file state, and upcoming refreshes.",
